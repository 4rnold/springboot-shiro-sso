//package com.arnold.ssoserver.common.controller;
//
...
//    @ResponseBody
//    public String listByPage(@RequestBody Map<String, Object> map) throws JsonProcessingException {
//        ObjectMapper objectMapper = new ObjectMapper();
//        String string = objectMapper.writeValueAsString(mapper.selectPage(
...
//
//        return new ObjectMapper().writeValueAsString(mapper.selectById(id));
//    }
//
